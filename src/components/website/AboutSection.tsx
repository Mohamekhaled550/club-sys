...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="relative py-32 bg-[#19090B] text-right overflow-hidden border-t border-white/5 bg-noise">
      ...
      <div className="absolute bottom-[10%] right-[-10%] w-[600px] h-[600px] bg-[#B76E79]/5 rounded-full blur-[160px] pointer-events-none z-0 transform-gpu" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-24">
          <div className="lg:col-span-8 space-y-4">
            ...
            <h2 className="text-4xl sm:text-6xl font-serif font-black text-white leading-[1.15]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E5D4C0] via-white to-slate-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-10">
            ...
            >
              ...
              <div className="flex items-start gap-6 relative z-10">
                <div className="p-4 bg-[#5A0B17]/30 rounded-2xl border border-[#B76E79]/30 text-[#E5D4C0]">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="relative p-10 bg-gradient-to-b from-[#24090E] to-[#120204] rounded-[28px] border border-white/5 space-y-8 shadow-[0_25px_60px_rgba(0,0,0,0.8)]">
              ...
              <div className="absolute top-[20%] left-[20%] w-32 h-32 bg-[#B76E79]/5 rounded-full blur-2xl pointer-events-none" />
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-4">
                    <CheckCircle2 className="w-5.5 h-5.5 text-[#E5D4C0] shrink-0 mt-0.5 stroke-[1.5]" />
                    <div>
              ...
              {/* ISO Ribbon Accent */}
              <div className="p-5 bg-gradient-to-r from-[#5A0B17]/40 via-[#2B0B12]/80 to-[#140708] border border-[#B76E79]/30 rounded-2xl flex items-center justify-between gap-4">
                <div className="space-y-1">
                  <span className="text-[10px] text-[#E5D4C0] font-black tracking-widest block uppercase">الاعتمادات والجودة</span>
                  <p className="text-xs font-bold text-white leading-relaxed">
                    معتمدة ومصنفة من وزارة الرياضة السعودية والاتحادات الرسمية للألعاب الرياضية الفردية والجماعية.
                  </p>
                </div>
                <div className="text-2xl font-serif font-black text-[#E5D4C0] bg-slate-950/55 px-4 py-2.5 rounded-xl border border-white/5 shadow-2xl">
                  ISO
                </div>
              </div>
