...
export const BookingSection: React.FC<BookingSectionProps> = ({ onAddToast }) => {
  ...
  return (
    <section id="booking-widget-section" className="relative py-32 bg-[#140708] text-right border-t border-white/5 bg-noise overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-[160px] pointer-events-none z-0"></div>
                        ...
                        return (
                          <div
                            ...
                            className={`p-4 rounded-2xl border cursor-pointer transition-all duration-300 flex items-center gap-4 ${
                              isSelected 
                                ? 'bg-[#5A0B17]/20 border-[#D4AF37] shadow-xl' 
                          ...
                          >
                            ...
                            <div className="text-left">
                              <span className="text-sm font-black text-[#D4AF37] block">{p.pricePerHour} ر.س</span>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-4 bg-slate-950/60 border border-white/10 rounded-xl focus:border-[#D4AF37] text-white outline-none font-semibold text-right"
                        />
                      </div>
                          ...
                          return (
                            <button
                              ...
                              className={`py-3.5 px-4 rounded-xl text-[11px] font-black transition-all cursor-pointer border ${
                                isSelected 
                                  ? 'bg-[#D4AF37] text-slate-950 border-[#D4AF37] shadow-lg shadow-[#D4AF37]/15' 
                  ...
                  <div className="space-y-6 animate-fade-in text-xs font-semibold">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-4 bg-slate-950/60 border border-white/10 rounded-xl focus:border-[#D4AF37] text-white outline-none font-semibold text-right text-xs"
                        />
                      </div>
                    ...
                    <div className="space-y-3 pt-2">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <label className="p-4 bg-slate-950/60 border border-white/5 hover:border-[#D4AF37]/50 rounded-xl flex items-center justify-between cursor-pointer transition-all">
                  ...
                  <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="p-6 bg-slate-950/80 border border-white/5 rounded-2xl space-y-4 text-xs font-semibold leading-relaxed">
                      ...
                      <div className="flex justify-between items-center text-slate-300 border-t border-white/5 pt-3">
                        ...
                        <span className="font-bold text-[#D4AF37]">{bookingData.payment}</span>
                      </div>
            ...
            <div className="flex items-center gap-4 pt-8 border-t border-white/5 relative z-10">
              ...
              {currentStep < 4 ? (
                <button
                  ...
                  className="flex-1 py-3.5 bg-gradient-to-r from-[#5A0B17] to-[#6E1120] border border-[#D4AF37]/30 hover:border-[#D4AF37] text-white font-black rounded-xl text-xs transition-all cursor-pointer text-center flex items-center justify-center gap-2 shadow-lg"
                >
                ...
                <button
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-[#D4AF37] via-[#C5A028] to-[#AA7C11] text-slate-950 font-black rounded-xl text-xs sm:text-sm transition-all cursor-pointer text-center flex items-center justify-center gap-2 shadow-2xl hover:scale-[1.01]"
                >
            ...
            <div className="bg-gradient-to-b from-[#1C0407] to-slate-950 border border-white/10 rounded-[28px] overflow-hidden shadow-2xl relative">
              ...
              <div className="h-56 overflow-hidden relative">
                ...
                <div className="absolute bottom-4 right-4">
                  <span className="bg-gradient-to-r from-[#D4AF37] to-[#AA7C11] text-slate-950 text-[10px] font-black px-3.5 py-1.5 rounded-full shadow-lg border border-[#D4AF37]/40 uppercase tracking-widest">
              ...
              <div className="p-8 space-y-6 text-right">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-3xl font-black text-[#D4AF37] flex items-baseline gap-1">
                    {totalPrice}
                    <span className="text-xs text-slate-300 font-bold">ر.س</span>
                  </div>
                </div>

                <div className="p-4 bg-[#5A0B17]/20 border border-[#D4AF37]/20 rounded-2xl flex items-start gap-3">
