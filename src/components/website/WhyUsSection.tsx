...
export const WhyUsSection: React.FC = () => {
  return (
    <section id="why-us" className="relative py-32 bg-[#24090E] text-right border-t border-white/5 bg-noise overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#B76E79]/5 rounded-full blur-[130px] pointer-events-none z-0 transform-gpu" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20 space-y-4">
          ...
          <h2 className="text-4xl sm:text-6xl font-serif font-black text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E5D4C0] to-white">الأشوال أكاديمي؟</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
          ...
          >
            ...
            <div className="absolute bottom-10 right-10 left-10 z-20 space-y-3">
              <span className="px-3.5 py-1.5 rounded-full bg-[#5A0B17]/90 border border-[#B76E79]/35 text-[#E5D4C0] text-[10px] font-black tracking-widest uppercase inline-block">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="w-14 h-14 rounded-2xl bg-[#5A0B17]/40 flex items-center justify-center border border-[#B76E79]/30 text-[#E5D4C0]">
          ...
          >
            <div className="space-y-6">
              <div className="w-14 h-14 rounded-2xl bg-white/[0.03] flex items-center justify-center border border-white/10 text-white">
                <Activity className="w-7 h-7 text-[#E5D4C0] stroke-[1.5]" />
              </div>
              <div className="space-y-3">
            ...
            <div className="pt-8 border-t border-white/5">
              <p className="text-[11px] text-[#E5D4C0] font-black tracking-widest uppercase flex items-center gap-1">
        ...
        <div className="mt-20 bg-gradient-to-r from-[#1E090B] via-[#24090E] to-[#120204] border border-white/5 rounded-[28px] p-8 sm:p-10 shadow-2xl flex flex-wrap items-center justify-around gap-8 text-center relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(183,110,121,0.03)_0%,transparent_50%)] pointer-events-none" />

          {[
            { val: '+٥,٠٠٠', label: 'ساعة تدريب محترفة', icon: <Clock className="w-5.5 h-5.5 text-[#E5D4C0] stroke-[1.5]" /> },
            { val: '+١٠ سنوات', label: 'مسيرة وعطاء رياضي', icon: <Award className="w-5.5 h-5.5 text-[#E5D4C0] stroke-[1.5]" /> },
            { val: '٥ فروع', label: 'بأرقى وأفخم مناطق الرياض', icon: <Shield className="w-5.5 h-5.5 text-[#E5D4C0] stroke-[1.5]" /> },
            { val: '+١٢٠ بطولة', label: 'محلية وإقليمية مكللة بذهب', icon: <Trophy className="w-5.5 h-5.5 text-[#E5D4C0] stroke-[1.5]" /> },
          ].map((item, idx) => (
